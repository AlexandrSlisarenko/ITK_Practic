...
public interface CustomerDataMapper {
    ...
    public abstract Customer toModelCreateCustomer(CustomerInformationDTO createCustomerDto);

    @Mapping(target = "orders", ignore = true)
    public abstract Customer toModelUpdateCustomer(CustomerInformationDTO createCustomerDto);

    @Mapping(target = "orders", ignore = true)
    public abstract CustomerInformationDTO toCustomerInformationUpdate(Customer customer);
